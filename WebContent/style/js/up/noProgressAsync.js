	...
	function fileUpload() {
		...
		document.getElementById('uploadButton').addEventListener('click', function() {
			...
			function initProgress() {
				...
				console.log('Uploading Your File to Our Server');

				// DOM Manipulations
				$('.forms').css('display', 'none');
				$('.notif').css('display', 'block');
				$('.states').text('Uploading Your File to Our Server');
			...
			function transferComplete() {
				...
				console.log('Upload Transfer is complete');
			...
			xhr.open('POST', '../UploadServletOne', true);
			xhr.send(fd);
